...
import { AutoComplete, Button, DatePicker, Form, Input, InputNumber, message, Modal, Switch } from 'antd';
...
const AddChildrenModal: React.FC<AddChildrenModalProps> = ({ visible, onClose }) => {
    ...
    const [createChildren, { isLoading: isCreating }] = useCreateChildrenMutation();
    ...
    const handleAddChildren = async (values: any) => {
        ...
        try {
            ...
            message.error(err.data?.title || err.data?.message || 'Không thể thêm trẻ');
        }
    };
        ...
        >
            {customerLoading ? (
                ...
                >
                    ...
                    >
                        <InputNumber style={{ width: '100%' }} min={1} placeholder="Nhập chiều cao" />
                    </Form.Item>
                    ...
                    >
                        <InputNumber style={{ width: '100%' }} min={1} placeholder="Nhập cân nặng" />
                    </Form.Item>
